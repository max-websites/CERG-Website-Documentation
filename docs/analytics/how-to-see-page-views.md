...
[Go to Google Analytics Pageviews & Sessions page :material-arrow-top-right-thick:](https://datastudio.google.com/u/7/reporting/78ed74d3-7641-46f1-96dd-ac15a22faf66/page/Xqh8B ){ .md-button .md-button--primary target="_blank"}
...
![Google Analytics](../img/analytics-page-view-source.png)
/// caption
Google Analytics page view results
///

!!! info "Tracking Sources"
    Go to [How to set up link tracking](how-to-set-up-link-tracking.md) for a list of sources.
...
<video controls width="100%">
  <source src="../video/viewing excel chart.mp4" type="video/mp4">
